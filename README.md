...
- **合格証モーダル**: メダルクリックで過去の合格証をポップアップ表示
...
- **再表示機能**: メダルクリックでlocalStorageから読み込み
